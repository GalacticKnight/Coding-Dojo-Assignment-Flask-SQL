from flask_app.config.mysqlconnection import connectToMySQL#CONFIG IS IMPORTANT **************************************
#the user class holds all the classes and methods that enables you to interact with the database
class User:
